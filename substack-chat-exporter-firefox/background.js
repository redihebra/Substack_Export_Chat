// Substack Chat Exporter - Firefox Background Script
// Port of Chrome extension using browser.* Promise-based APIs
...
async function handleExport(postId) {
  try {
    ...
    // Download by sending markdown to popup for Blob download
    safeSendMessage({
      action: "download",
      markdown,
      filename,
